...
exports.DigioptionsLogoAnim = exports.DigioptionsSpinner = void 0;
...
class DigioptionsSpinnerCore extends react_1.default.PureComponent {
    constructor() {
        super(...arguments);
        this.render = function () {
            const { stroke, fill, fillOpacity, strokeWidth, once } = this.props;
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("circle", { style: { marker: 'none' }, strokeWidth: strokeWidth, cy: "114.103", cx: "114.103", r: "114.103", fill: `rgb(${fill})`, fillOpacity: fillOpacity, fillRule: "nonzero" }),
                react_1.default.createElement("g", { clipPath: `path("${digiOptionsLogoPathClip}")` },
                    react_1.default.createElement("circle", { style: { marker: 'none' }, cy: "114.103", cx: "114.103", r: "114.103", fill: stroke, fillOpacity: 0.0, fillRule: "nonzero" }),
                    react_1.default.createElement("path", { strokeDasharray: "750", fill: "none", stroke: stroke, strokeLinejoin: "miter", strokeWidth: "60", d: digiOptionsLogoPath }, once ?
                        react_1.default.createElement("animate", { attributeName: "stroke-dashoffset", begin: "0.0s", dur: "1.5s", values: "-750;0", calcMode: "linear", repeatCount: "1" })
                        :
                            react_1.default.createElement("animate", { attributeName: "stroke-dashoffset", begin: "0.0s", values: "-750;750", dur: "3s", calcMode: "linear", repeatCount: "indefinite" })))));
        };
    }
}
...
class DigioptionsSpinner extends react_1.default.PureComponent {
    constructor() {
        ...
        this.render = function () {
            ...
            return (react_1.default.createElement("svg", Object.assign({ className: "digioptions-spinner", xmlns: "http://www.w3.org/2000/svg", viewBox: `0 0 ${digiOptionsLogoWidth} ${digiOptionsLogoHeight}` }, rest),
                react_1.default.createElement(DigioptionsSpinnerCore, { stroke: stroke, fill: fill, fillOpacity: fillOpacity, strokeWidth: strokeWidth, once: false })));
        };
    }
}
...
class DigioptionsLogoAnim extends react_1.default.PureComponent {
    constructor() {
        super(...arguments);
        this.render = function () {
            const _a = this.props, { stroke, fill, fillOpacity, strokeWidth, color0, color1 } = _a, rest = __rest(_a, ["stroke", "fill", "fillOpacity", "strokeWidth", "color0", "color1"]);
...
//# sourceMappingURL=digioptions_spinner.js.map