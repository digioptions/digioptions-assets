...
class DigioptionsSpinner extends React.PureComponent {
    render = function () {
        ...
        return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 228.206 228.206", ...rest },
            ...
            React.createElement("g", { clipPath: "path('M93.127 170.313c.153.061.303.116.454.17 31.118 11.327 65.576-4.74 76.902-35.86 11.326-31.117-4.742-65.576-35.86-76.902-31.118-11.326-65.577 4.744-76.903 35.86l-27.355 75.161c-16.573-25.457-21.41-58.127-10.232-88.84C39.01 28.038 96.443 1.257 148.304 20.133c51.866 18.877 78.643 76.31 59.767 128.17-18.876 51.862-76.305 78.645-128.17 59.767-13.542-4.928-25.376-12.486-35.133-21.89l16.14-44.344.011.014 14.772-40.585c.114-.342.23-.677.353-1.015 7.59-20.852 30.568-31.692 51.452-24.367z')" },
                React.createElement("circle", { style: { marker: 'none' }, strokeWidth: strokeWidth, cy: "114.103", cx: "114.103", r: "114.103", fill: '#ffffff', fillOpacity: 0.5, fillRule: "nonzero" }),
...
class DigioptionsSpinnerProgressBox extends React.PureComponent {
    render() {
        ...
        return (React.createElement("div", { style: Object.assign({ width: '120px', margin: 'auto' }, this.props.style) },
            React.createElement(DigioptionsSpinner, { width: '60%' }),
            React.createElement("div", { style: { backgroundColor: `rgba(${this.props.fill}, ${this.props.fillOpacity})`, borderRadius: '5px', padding: '5px', marginTop: '5px',
                } },
...
export { DigioptionsSpinner, DigioptionsSpinnerProgressBox, };
