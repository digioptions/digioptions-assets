...
class DigioptionsSpinner extends React.PureComponent {
    render = function () {
        ...
        return (React.createElement("svg", { className: "digioptions-spinner", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 228.206 228.206", ...rest },
...
class DigioptionsProgressBar extends React.PureComponent {
    render() {
        ...
        return (React.createElement("div", { style: styleFinal },
            React.createElement(ProgressBar, { style: { backgroundColor: '#e3f0f9' }, now: percent, label: label })));
    }
}
...
class DigioptionsSpinnerProgressBox extends React.PureComponent {
    render() {
        ...
        //      </div>
        //    );
        return (React.createElement("div", { className: className, style: Object.assign({ margin: 'auto', maxWidth: 200 }, style) },
            React.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                React.createElement(DigioptionsSpinner, { width: '60px' }),
                React.createElement(DigioptionsProgressBar, { style: { flexGrow: 1, marginLeft: 10 }, ...rest }))));
    }
}
//dc_blue_background
...
export { DigioptionsSpinner, DigioptionsProgressBar, DigioptionsSpinnerProgressBox, };
