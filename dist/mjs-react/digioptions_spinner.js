...
class DigioptionsSpinnerCore extends React.PureComponent {
    render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("circle", { style: { marker: 'none' }, strokeWidth: strokeWidth, cy: "114.103", cx: "114.103", r: "114.103", fill: `rgb(${fill})`, fillOpacity: fillOpacity, fillRule: "nonzero" }),
            React.createElement("g", { clipPath: `path("${digiOptionsLogoPathClip}")` },
                React.createElement("circle", { style: { marker: 'none' }, cy: "114.103", cx: "114.103", r: "114.103", fill: stroke, fillOpacity: 0.0, fillRule: "nonzero" }),
                React.createElement("path", { strokeDasharray: "750", fill: "none", stroke: stroke, strokeLinejoin: "miter", strokeWidth: "60", d: digiOptionsLogoPath }, once ?
                    React.createElement("animate", { attributeName: "stroke-dashoffset", begin: "0.0s", dur: "1.5s", values: "-750;0", calcMode: "linear", repeatCount: "1" })
                    :
                        React.createElement("animate", { attributeName: "stroke-dashoffset", begin: "0.0s", values: "-750;750", dur: "3s", calcMode: "linear", repeatCount: "indefinite" })))));
    };
}
...
class DigioptionsSpinner extends React.PureComponent {
    render = function () {
        ...
        return (React.createElement("svg", { className: "digioptions-spinner", xmlns: "http://www.w3.org/2000/svg", viewBox: `0 0 ${digiOptionsLogoWidth} ${digiOptionsLogoHeight}`, ...rest },
            React.createElement(DigioptionsSpinnerCore, { stroke: stroke, fill: fill, fillOpacity: fillOpacity, strokeWidth: strokeWidth, once: false })));
    };
}
...
export { DigioptionsSpinner, DigioptionsLogoAnim, };
