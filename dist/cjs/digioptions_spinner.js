...
class DigioptionsSpinnerCore extends react_1.default.PureComponent {
    constructor() {
        ...
        <g clipPath={`path("${digiOptionsLogoPathClip}")`}>
          ...
          <path strokeDasharray="750" fill="none" stroke={stroke} strokeLinejoin="miter" strokeWidth="60" d={digiOptionsLogoPath}>
            {once ?
                    <animate attributeName="stroke-dashoffset" begin="0.0s" dur="1.5s" values="-750;0" calcMode="linear" repeatCount="1"/>
                    :
...
class DigioptionsSpinner extends react_1.default.PureComponent {
    constructor() {
        ...
        this.render = function () {
            ...
            return (<svg className="digioptions-spinner" xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 ${digiOptionsLogoWidth} ${digiOptionsLogoHeight}`} {...rest}>
        <DigioptionsSpinnerCore stroke={stroke} fill={fill} fillOpacity={fillOpacity} strokeWidth={strokeWidth} once={false}/>
      </svg>);
        };
    }
}
...
class DigioptionsLogoAnim extends react_1.default.PureComponent {
    constructor() {
        ...
        this.render = function () {
            ...
            return (<svg xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 ${width} ${digiOptionsLogoHeight}`} {...rest}>
        <defs>
          <clipPath id="cp">
        ...
        <g transform={`translate(${width / 2 - digiOptionsLogoWidth / 2}, 0)`}>
          ...
          <g clipPath="url(#cp)">
            <g transform={`translate(${digiOptionsLogoWidth / 2 + 75 - digiOptionsTextWidthScaled}, ${digiOptionsTextPaddingTop})`}>
              <g transform={`scale(${digiOptionsTextScale})`}>
              ...
              <animateTransform attributeName="transform" attributeType="XML" begin="2.0s" dur="1.2s" type="translate" from={`${digiOptionsLogoWidth / 2 + 75 - digiOptionsTextWidthScaled} ${digiOptionsTextPaddingTop}`} to={`${width - digiOptionsTextWidthScaled} ${digiOptionsTextPaddingTop}`} repeatCount="1" fill="freeze"/>
            </g> 
          </g> 
          <DigioptionsSpinnerCore stroke={stroke} fill={fill} fillOpacity={fillOpacity} strokeWidth={strokeWidth} once={true}/>
          <animateTransform attributeName="transform" attributeType="XML" begin="2.0s" dur="1.2s" type="translate" from={`${width / 2 - digiOptionsLogoWidth / 2} 0`} to="0 0" repeatCount="1" fill="freeze"/>
        </g> 
      </svg>);
        };
    }
