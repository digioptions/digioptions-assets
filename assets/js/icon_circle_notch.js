...
class IconCircleNotch extends React.PureComponent {
  render(){
    //console.log('IconCircleNotch');
    const {stroke, ...rest} = this.props;
    return(
      <svg xmlns="http://www.w3.org/2000/svg" className="spin" width="100px" height="100px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" {...rest}>
...
IconCircleNotch.defaultProps = {stroke: '#666666'};
